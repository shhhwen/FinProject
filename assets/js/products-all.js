...
const mockData = [
    ...
    { id: 5, name: "蜥蜴的尾巴", enName: "Lizard Tail", price: 50, stock: 30, image: "../assets/img/products/good5.png", description: "最基本的耗材，便宜而且泛用。", ingredients: ["新鮮蜥蜴尾巴", "濕地苔蘚"] },
    { id: 6, name: "魔力粉", enName: "Magic Powder", price: 250, stock: 25, image: "../assets/img/products/good6.png", description: "魔法藥水的催化劑，製作魔法藥水。", ingredients: ["星塵碎片", "彩虹石粉末", "龍木屑"] },
    { id: 7, name: "兔子的腳", enName: "Rabbit Foot", price: 600, stock: 18, image: "../assets/img/products/good7.png", description: "幸運的象徵，可以當作吊飾，也能增加製作魔法藥水的成功機率。", ingredients: ["兔子後腳"] },
    { id: 8, name: "鳳凰羽毛", enName: "Phoenix Feather", price: 300000, stock: 2, image: "../assets/img/products/good8.png", description: "用於製作再生或治療功能的藥水，稀有而且非常好看。", ingredients: ["鳳凰尾羽"] },
    { id: 9, name: "古代恐龍的化石", enName: "Ancient Dinosaur Fossil", price: 2500000, stock: 1, image: "../assets/img/products/good9.png", description: "用於製作提升力量的藥水，買一根擺在客廳會非常帥氣。", ingredients: ["恐龍化石碎片", "地底熔岩石"] },
    ...
    { id: 11, name: "靈光藍花", enName: "Soul Glow Blueflower", price: 3520, stock: 7, image: "../assets/img/products/good11.png", description: "祭祀魔法的媒介，用以祭祀死去的人、撫慰他們的靈魂。", ingredients: ["靈光藍花花瓣", "星夜之水"] },
    { id: 12, name: "魔法掃帚", enName: "Magic Broomstick", price: 12900, stock: 4, image: "../assets/img/products/good12.png", description: "就是可以飛的掃把。", ingredients: ["魔法木材", "強化魔法結界符文"] },
    ...
    { id: 15, name: "記憶吐司", enName: "Memory Toast", price: 790, stock: 15, image: "../assets/img/products/good15.png", description: "將想記住的事寫上去後再吃掉就會一直記得，直到排泄出來。", ingredients: ["忘憂草籽粉", "書頁碎片", "符咒墨水","麵粉"] },
